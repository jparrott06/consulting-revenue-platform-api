...
func TestV1TimeEntries_ListForbiddenWhenContractorFiltersOtherUser(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/v1/time-entries?user_id="+other.String(), nil)
