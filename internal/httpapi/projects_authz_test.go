...
func TestV1Projects_PostForbiddenForContractor(t *testing.T) {
	...
	body := `{"client_id":"44444444-4444-4444-4444-444444444444","name":"P","billing_mode":"hourly","default_rate_minor":10000}`
