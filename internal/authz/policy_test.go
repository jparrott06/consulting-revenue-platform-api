...
func TestRoleAllows_Matrix(t *testing.T) {
	tests := []struct {
		...
		{"owner", ActionTimeEntryRead, true},
		{"contractor", ActionTimeEntryRead, true},
		{"owner", ActionTimeEntryWrite, true},
		{"contractor", ActionTimeEntryWrite, true},
		{"owner", ActionInvoiceWrite, true},
		{"accountant", ActionInvoiceWrite, true},
		{"contractor", ActionInvoiceWrite, false},
		{"owner", ActionLedgerRead, true},
		{"accountant", ActionLedgerRead, true},
		{"contractor", ActionLedgerRead, false},
		...
		{"owner", ActionOrganizationDeactivate, true},
		{"accountant", ActionOrganizationDeactivate, false},
		{"contractor", ActionOrganizationDeactivate, false},
	}
