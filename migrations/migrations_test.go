...
func TestLedgerEntriesMigrationFilesExist(t *testing.T) {
	t.Parallel()

	paths := []string{
		filepath.Join("000016_ledger_entries.up.sql"),
		filepath.Join("000016_ledger_entries.down.sql"),
	}
...
func TestPaymentsStripeIdsMigrationFilesExist(t *testing.T) {
	...
	paths := []string{
		filepath.Join("000014_payments_stripe_ids.up.sql"),
		filepath.Join("000014_payments_stripe_ids.down.sql"),
	}
...
func TestWebhookEventsMigrationFilesExist(t *testing.T) {
	...
	paths := []string{
		filepath.Join("000012_webhook_events.up.sql"),
		filepath.Join("000012_webhook_events.down.sql"),
	}
...
func TestAuditLogsMigrationFilesExist(t *testing.T) {
	t.Parallel()

	paths := []string{
		filepath.Join("000017_audit_logs.up.sql"),
		filepath.Join("000017_audit_logs.down.sql"),
	}
